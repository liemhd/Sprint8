...
final class ListUserView: UIView {
    ...
    //MARK: Properties
    private let dataUserArr: [User] = [User(name: "Tuan(Mr.)", avatar: #imageLiteral(resourceName: "imv_boy")),
                                       User(name: "Nyonya(Mrs.)", avatar: #imageLiteral(resourceName: "imv_women")),
                                       User(name: "Nona(Ms.)", avatar: #imageLiteral(resourceName: "imv_girl"))]
